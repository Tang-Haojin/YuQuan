...
case class RVM()(implicit val p: Parameters) extends CPUParams {
  private def MUL    = BitPat("b0000001_?????_?????_000_?????_0110011")
  private def MULH   = BitPat("b0000001_?????_?????_001_?????_0110011")
  private def MULHSU = BitPat("b0000001_?????_?????_010_?????_0110011")
  private def MULHU  = BitPat("b0000001_?????_?????_011_?????_0110011")
  private def DIV    = BitPat("b0000001_?????_?????_100_?????_0110011")
  private def DIVU   = BitPat("b0000001_?????_?????_101_?????_0110011")
  private def REM    = BitPat("b0000001_?????_?????_110_?????_0110011")
  private def REMU   = BitPat("b0000001_?????_?????_111_?????_0110011")

  private def MULW   = BitPat("b0000001_?????_?????_000_?????_0111011")
  private def DIVW   = BitPat("b0000001_?????_?????_100_?????_0111011")
  private def DIVUW  = BitPat("b0000001_?????_?????_101_?????_0111011")
  private def REMW   = BitPat("b0000001_?????_?????_110_?????_0111011")
  private def REMUW  = BitPat("b0000001_?????_?????_111_?????_0111011")
