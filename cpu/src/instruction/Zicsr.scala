...
case class Zicsr()(implicit val p: Parameters) extends CPUParams {
  private def CSRRW  = BitPat("b????????????_?????_001_?????_1110011")
  private def CSRRS  = BitPat("b????????????_?????_010_?????_1110011")
  private def CSRRC  = BitPat("b????????????_?????_011_?????_1110011")
  private def CSRRWI = BitPat("b????????????_?????_101_?????_1110011")
  private def CSRRSI = BitPat("b????????????_?????_110_?????_1110011")
  private def CSRRCI = BitPat("b????????????_?????_111_?????_1110011")
