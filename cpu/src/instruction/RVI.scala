...
case class RVI()(implicit val p: Parameters) extends CPUParams {
  ...
  val table = List(
    ...
    JAL   -> List(InstrTypes.j, pc  , four, imm , non , add , 1.U, ExecSpecials.non   ),
    JALR  -> List(InstrTypes.i, pc  , four, imm , rs1 , add , 1.U, ExecSpecials.non   ),
    BEQ   -> List(InstrTypes.b, rs1 , rs2 , imm , non , equ , 0.U, ExecSpecials.non   ),
    BNE   -> List(InstrTypes.b, rs1 , rs2 , imm , non , neq , 0.U, ExecSpecials.non   ),
    BLT   -> List(InstrTypes.b, rs1 , rs2 , imm , non , lts , 0.U, ExecSpecials.non   ),
    BGE   -> List(InstrTypes.b, rs1 , rs2 , imm , non , ges , 0.U, ExecSpecials.non   ),
    BLTU  -> List(InstrTypes.b, rs1 , rs2 , imm , non , ltu , 0.U, ExecSpecials.non   ),
    BGEU  -> List(InstrTypes.b, rs1 , rs2 , imm , non , geu , 0.U, ExecSpecials.non   ),
