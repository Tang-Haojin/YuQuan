...
case class RVI()(implicit val p: Parameters) extends CPUParams {
  ...
  def LWU    = if(xlen!=32) BitPat("b???????_?????_?????_110_?????_0000011") else ERR
  def LD     = if(xlen!=32) BitPat("b???????_?????_?????_011_?????_0000011") else ERR
  def SD     = if(xlen!=32) BitPat("b???????_?????_?????_011_?????_0100011") else ERR
  def ADDIW  = if(xlen!=32) BitPat("b???????_?????_?????_000_?????_0011011") else ERR
  def SLLIW  = if(xlen!=32) BitPat("b000000?_?????_?????_001_?????_0011011") else ERR
  def SRLIW  = if(xlen!=32) BitPat("b000000?_?????_?????_101_?????_0011011") else ERR
  def SRAIW  = if(xlen!=32) BitPat("b010000?_?????_?????_101_?????_0011011") else ERR
  def ADDW   = if(xlen!=32) BitPat("b0000000_?????_?????_000_?????_0111011") else ERR
  def SUBW   = if(xlen!=32) BitPat("b0100000_?????_?????_000_?????_0111011") else ERR
  def SLLW   = if(xlen!=32) BitPat("b0000000_?????_?????_001_?????_0111011") else ERR
  def SRLW   = if(xlen!=32) BitPat("b0000000_?????_?????_101_?????_0111011") else ERR
  def SRAW   = if(xlen!=32) BitPat("b0100000_?????_?????_101_?????_0111011") else ERR
