...
private class FromCPU(fromCPU: AxiMasterChannel, toDevice: ToDevice, toCPU: ToCPU, devAddr: UInt, cpuAddr: UInt, transLen: UInt, free: Bool) {
...
private class ToCPU(toCPU: AxiMasterChannel, toDevice: ToDevice, fifo: QueueIO[UInt], free: Bool, cpuAddr: UInt) {
...
private class ToDevice(toDevice: AxiMasterChannel, fifo: QueueIO[UInt], devAddr: UInt) {
